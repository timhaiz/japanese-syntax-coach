...
export const questionBank:Record<number,Question[]> = {
  1: build(1,drafts([
    ['翻译','我是学生。','私は学生です。','A は B です'],['翻译','我不是老师。','私は先生ではありません。','ではありません = 不是'],['助词','这是 ___ 我的书。','これは私の本です。','用 の 连接所属'],['翻译','田中先生是学生吗？','田中さんは学生ですか。','句尾加 ですか'],['翻译','我是公司职员。','私は会社員です。','A は B です'],['翻译','小李不是医生。','李さんは医者ではありません。','ではありません = 不是'],['助词','这是 ___ 佐藤先生的伞。','これは佐藤さんの傘です。','用 の 连接所属'],['翻译','那个人是日本人吗？','あの人は日本人ですか。','句尾加 ですか'],['翻译','我不是大学生。','私は大学生ではありません。','ではありません = 不是'],['翻译','山田先生是老师。','山田さんは先生です。','A は B です'],['翻译','我是中国人。','私は中国人です。','A は B です'],['翻译','我不是日本人。','私は日本人ではありません。','ではありません = 不是'],['翻译','这是我的日语书。','これは私の日本語の本です。','A の B'],['翻译','那个人是田中的老师吗？','あの人は田中さんの先生ですか。','の + ですか'],['翻译','那本书不是我的。','あの本は私のではありません。','名词 + の + ではありません'],['问答','これは何ですか。（这是杂志。）','雑誌です。','何ですか = 什么'],['问答','あの人は田中さんですか。（是的。）','はい、田中さんです。','はい + 名词 + です'],['选择','“这是我的书。”选择正确项。','B','これは私の本です。'],['选择','“这本书是田中的。”选择正确项。','C','この本は田中さんのです。'],['选择','“那是日本的杂志吗？”选择正确项。','A','あれは日本の雑誌ですか。']
  ])),
  2: build(2,drafts([
